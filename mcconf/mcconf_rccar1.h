...
#define MCPWM_CYCLE_INT_LIMIT_MIN_RPM	1300.0	// Minimum RPM to calculate the BEMF coupling from
#define MCPWM_CYCLE_INT_LIMIT			42.0	// Flux integrator limit 0 ERPM
