#ifndef MCCONF_VPT_H_
#define MCCONF_VPT_H_
...
#define MCCONF_L_BATTERY_CUT_START		16.0	// Start limiting the positive current at this voltage
#endif
#ifndef MCCONF_L_BATTERY_CUT_END
#define MCCONF_L_BATTERY_CUT_END		16.0	// Limit the positive current completely at this voltage
#endif
...
#define MCCONF_L_MAX_DUTY				0.9999	// Maximum duty cycle
#endif
...
#define MCCONF_L_LIM_TEMP_MOTOR_START	90.0	// MOTOR temperature where current limiting should begin
#endif
...
#define MCCONF_S_PID_KP					0.008	// Proportional gain
#endif
#ifndef MCCONF_S_PID_KI
#define MCCONF_S_PID_KI					0.004	// Integral gain
#endif
#ifndef MCCONF_S_PID_KD
#define MCCONF_S_PID_KD					0.0002	// Derivative gain
#endif
...
#define MCCONF_CC_GAIN					0.0		// Current controller error gain
#endif
#ifndef MCCONF_CC_MIN_CURRENT
#define MCCONF_CC_MIN_CURRENT			0.0		// Minimum allowed current
#endif
#ifndef MCCONF_CC_STARTUP_BOOST_DUTY
#define MCCONF_CC_STARTUP_BOOST_DUTY	0.0		// The lowest duty cycle to use in current control mode (has to be > MCPWM_MIN_DUTY_CYCLE)
#endif
#ifndef MCCONF_CC_RAMP_STEP
#define MCCONF_CC_RAMP_STEP				0.0		// Maximum duty cycle ramping step in CC mode
#endif
...
#define MCCONF_SL_MIN_ERPM_CYCLE_INT_LIMIT	2000.0	// Minimum RPM to calculate the BEMF coupling from
#endif
...
#define MCCONF_FOC_F_SW					32000.0
#endif
...
#define MCCONF_FOC_MOTOR_L				6.41e-6
#endif
...
#define MCCONF_FOC_OBSERVER_GAIN		4.9677e8	// Can be something like 600 / L
#endif
...
#define MCCONF_M_FAULT_STOP_TIME		1		// Ignore commands for this duration in msec when faults occur
#endif
...
#define MCCONF_M_NTC_MOTOR_BETA			3425.0 // Beta value for motor termistor
#endif
