...
#define MCPWM_CYCLE_INT_LIMIT_LOW		30.0	// Flux integrator limit 0 ERPM
#define MCPWM_CYCLE_INT_LIMIT_HIGH		10.0	// Flux integrator limit MCPWM_CYCLE_INT_START_RPM_BR ERPM
