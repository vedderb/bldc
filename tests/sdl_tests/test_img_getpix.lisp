...
(define win (sdl-create-window "GetPixel Test" 400 200))
...
(img-setpix img400x200 200 100 1)
(define test3 (= (img-getpix img400x200 200 100) 1))

;; Test 4: Set and get pixel at corner
(img-setpix img400x200 399 199 1)
(define test4 (= (img-getpix img400x200 399 199) 1))
...
;; Test 7-10: Set and verify different colors indexed2
...
(img-setpix img400x200 30 10 1)
(define test9 (= (img-getpix img400x200 30 10) 1))

(img-setpix img400x200 40 10 1)
(define test10 (= (img-getpix img400x200 40 10) 1))
...
(img-setpix img400x200 100 50 1)
(define test13a (= (img-getpix img400x200 100 50) 1))    ; Set pixel
...
(img-setpix img400x200 151 75 1)
(img-setpix img400x200 152 75 1)
(define test18a (= (img-getpix img400x200 150 75) 1))
(define test18b (= (img-getpix img400x200 151 75) 1))
(define test18c (= (img-getpix img400x200 152 75) 1))
