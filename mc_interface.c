...
typedef struct {
	...
	int32_t m_motor_current_iterations;
	int32_t m_input_current_iterations;
	float m_motor_id_sum;
	float m_motor_iq_sum;
	int32_t m_motor_id_iterations;
	int32_t m_motor_iq_iterations;
	float m_motor_vd_sum;
	float m_motor_vq_sum;
	int32_t m_motor_vd_iterations;
	int32_t m_motor_vq_iterations;
	float m_amp_seconds;
