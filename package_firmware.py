...
package_dict["MKSESC_75_100"] = [['mksesc_75_100_old', default_name],
                    ['mksesc_75_100_old_no_limits', no_limits_name]]
package_dict["MKSESC_75_100_V2"] = [['mksesc_75_100_v2_old', default_name],
                    ['mksesc_75_100_v2_old_no_limits', no_limits_name],
                    ['mksesc_75_100_v2', default_name],
                    ['mksesc_75_100_v2_no_limits', no_limits_name]]
package_dict["MKSESC_75_200_V2"] = [['mksesc_75_200_v2_old', default_name],
                    ['mksesc_75_200_v2_old_no_limits', no_limits_name],
                    ['mksesc_75_200_v2', default_name],
...
for directory in package_dict:
    ...
    for target in package_dict[directory]:
        ...
        destination_target_folder = os.path.join(destination_path, target[0])
        os.makedirs(destination_target_folder, exist_ok=True)
        ...
        # Copy the file
        shutil.copy(os.path.join(build_dir, target[0], origin_file_name), os.path.join(destination_target_folder, destination_file_name))
