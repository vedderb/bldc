...
#ifndef HW_FLIPSKY_110_CORE_H_
#define HW_FLIPSKY_110_CORE_H_


#ifdef HW_FLIPSKY_110_100
  #define HW_NAME					"Flipsky_110_100"
#elif defined(HW_FLIPSKY_110_200)
...
#define NTC_TEMP(adc_ind)		hw110_get_temp()
...
#define MCCONF_L_MAX_VOLTAGE			150.0	// Maximum input voltage
#endif
...
float hw110_get_temp(void);

#endif /* HW_FLIPSKY_110_H_ */
