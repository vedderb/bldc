...
#ifdef HW_USE_I2CD1 // I2C: (1, 0) (1, 6)
#define STM32_SPI_SPI3_RX_DMA_STREAM        STM32_DMA_STREAM_ID(1, 2) // (1, 0) (1, 2)
#define STM32_SPI_SPI3_TX_DMA_STREAM        STM32_DMA_STREAM_ID(1, 7) // (1, 5) (1, 7)
#else // I2C: (1, 2) (1, 7)
#define STM32_SPI_SPI3_RX_DMA_STREAM        STM32_DMA_STREAM_ID(1, 0) // (1, 0) (1, 2)
#define STM32_SPI_SPI3_TX_DMA_STREAM        STM32_DMA_STREAM_ID(1, 5) // (1, 5) (1, 7)
#endif
