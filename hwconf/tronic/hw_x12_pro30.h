...
//#define HW_USE_BRK //BRK Optional
...
#define CURRENT_AMP_GAIN		(1.35/375)
//Isolated current ring sensors for 375A, half sensitivity of 24s version
//MUST be used with single split ring
