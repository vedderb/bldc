...
#define CURRENT_FILTER_OFF()		palSetPad(GPIOD, 2)
...
#define HW_LIM_VIN			8.0, 84.0
#define HW_LIM_ERPM			-160e3, 160e3
#define HW_LIM_DUTY_MIN			0.0, 0.1
#define HW_LIM_DUTY_MAX			0.0, 0.95
#define HW_LIM_TEMP_FET			-40.0, 90.0

//#define DRV8323S_CUSTOM_SETTINGS();  drv8323s_write_reg(5,0b0000000101000100);
