...
#define HW_NAME					"FSESC_75_200_ALU"
...
#define MCCONF_L_MAX_ABS_CURRENT		350.0	// (jaykup) (flipsky firmware) The maximum absolute current above which a fault is generated
#endif
...
#define MCCONF_L_IN_CURRENT_MAX			150.0	// (jaykup) (flipsky firmware) Input current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_IN_CURRENT_MIN
#define MCCONF_L_IN_CURRENT_MIN			-150.0	// (jaykup) (flipsky firmware) Input current limit in Amperes (Lower)
#endif
