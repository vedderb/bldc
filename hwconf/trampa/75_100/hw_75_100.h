...
//#define ADC_IND_TEMP_MOS_2		15 //(jaykup) 75/300 and 100/250 have 3 temp sensors.  This has one.
...
#define CURRENT_AMP_GAIN		20.0 // (jaykup) == default, unknown value ==
#endif
...
#define NTC_TEMP(adc_ind)		(1.0 / ((logf(NTC_RES(ADC_Value[adc_ind]) / 10000.0) / 3300.0) + (1.0 / 298.15)) - 273.15) 
...
// Permanent UART Peripheral (for NRF51) (jaykup) for UART2 port
...
#define MCCONF_L_MAX_VOLTAGE			84.0	// (jaykup) (flipsky firmware)
#endif
#ifndef MCCONF_DEFAULT_MOTOR_TYPE
#define MCCONF_DEFAULT_MOTOR_TYPE		MOTOR_TYPE_FOC
#endif
#ifndef MCCONF_FOC_F_SW
#define MCCONF_FOC_F_SW					30000.0 // (jaykup) (flipsky firmware)
#endif
...
#define HW_LIM_VIN				12.0, 120.0 // (jaykup) (flipsky firmware)
