...
#ifndef HW_GP_CORE_H_
#define HW_GP_CORE_H_

#ifdef HWSPARKF_IS_MK1
#define HW_NAME					"SPARKF"
#else
...
// Relay state
#define REL_GPIO				GPIOB
#define REL_PIN					12
#define REL_ACTIVE()			(palReadPad(REL_GPIO, REL_PIN))
...
// I2C Peripheral (does not exist on this HW)
