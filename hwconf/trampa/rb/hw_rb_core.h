...
#ifndef HW_RB_CORE_H_
#define HW_RB_CORE_H_
...
// Brake Switch
#define BRAKE_SW_GPIO			GPIOB
#define BRAKE_SW_PIN			0
#define BRAKE_SW_ACTIVE()		(!palReadPad(BRAKE_SW_GPIO, BRAKE_SW_PIN))

// Front Light
#define FRONT_LIGHT_GPIO		GPIOC
#define FRONT_LIGHT_PIN			10
#define FRONT_LIGHT_ON()		palSetPad(FRONT_LIGHT_GPIO, FRONT_LIGHT_PIN)
#define FRONT_LIGHT_OFF()		palClearPad(FRONT_LIGHT_GPIO, FRONT_LIGHT_PIN)

// Rear Light
#define REAR_LIGHT_GPIO			GPIOC
#define REAR_LIGHT_PIN			11
#define REAR_LIGHT_ON()			palSetPad(REAR_LIGHT_GPIO, REAR_LIGHT_PIN)
#define REAR_LIGHT_OFF()		palClearPad(REAR_LIGHT_GPIO, REAR_LIGHT_PIN)
