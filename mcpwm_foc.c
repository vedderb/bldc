...
static void control_current(volatile motor_state_t *state_m, float dt) {
	...
	state_m->vd = state_m->vd - state_m->iq * m_pll_speed * m_conf->foc_motor_lq;//Lq
	state_m->vq = state_m->vq + m_pll_speed * (state_m->id * m_conf->foc_motor_ld +
												m_conf->foc_motor_flux_linkage);//Ld
