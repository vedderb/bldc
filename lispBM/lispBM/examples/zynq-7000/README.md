# LispBM REPL in FreeRTOS for Zynq 7000
...
This example has been tested on AMD/Xiling Vitis 2025.2 on a TE0726-03 (The so-called ZynqBerry) 
development board from Trenz Electronic.

# Requirements

This example requires a Zynq 7000 platform (A9 32Bit processor).
...
# Building
 ...
 4. Select hardware platform. This must be a 32bit zynq 7000 platform.
...
include("${LISPBM_DIR}/examples/zynq-7000/lispbm_sources.cmake")
...
The A9 is a very capable 32bit processor and systems based on it
