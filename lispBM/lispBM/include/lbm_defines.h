...
#define ENC_SYM_ARRAY_READ          ENC_SYM(SYM_ARRAY_READ)
#define ENC_SYM_ARRAY_WRITE         ENC_SYM(SYM_ARRAY_WRITE)
#define ENC_SYM_ARRAY_CREATE        ENC_SYM(SYM_ARRAY_CREATE)
#define ENC_SYM_ARRAY_SIZE          ENC_SYM(SYM_ARRAY_SIZE)
#define ENC_SYM_ARRAY_CLEAR         ENC_SYM(SYM_ARRAY_CLEAR)
