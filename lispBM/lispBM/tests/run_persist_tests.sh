...
expected_fails=("repl_tests/test_failure.lisp")
...
logfile="log_persist_tests_${date}.log"
...
cd ../repl
rm -f persist_tests_cov.json
gcovr --filter ../src --gcov-ignore-parse-errors=negative_hits.warn --json persist_tests_cov.json
cd ../tests
