...
(bufset-f32 signal-re 8 1.0 'little-endian)

(define r0 (and (= (bufget-f32 signal-re 8 'little-endian) 1.0)
                (= (bufget-f32 signal-re 0 'little-endian) 0)))
...
(define res-cmplx (complex-correlate signal-re signal-im  filter-re filter-im 'little-endian))
