...
int32_t confgenerator_serialize_appconf(uint8_t *buffer, const app_configuration *conf) {
	...
	buffer[ind++] = conf->app_adc_conf.adc_filter_type;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.adc_filter_smoothing_constant, &ind);
	buffer[ind++] = conf->app_adc_conf.adc2_filter_type;
	buffer_append_float32_auto(buffer, conf->app_adc_conf.adc2_filter_smoothing_constant, &ind);
...
bool confgenerator_deserialize_appconf(const uint8_t *buffer, app_configuration *conf) {
	...
	conf->app_adc_conf.adc_filter_type = buffer[ind++];
	conf->app_adc_conf.adc_filter_smoothing_constant = buffer_get_float32_auto(buffer, &ind);
	conf->app_adc_conf.adc2_filter_type = buffer[ind++];
	conf->app_adc_conf.adc2_filter_smoothing_constant = buffer_get_float32_auto(buffer, &ind);
...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_adc_conf.adc_filter_type = APPCONF_ADC_FILTER_TYPE;
	conf->app_adc_conf.adc_filter_smoothing_constant = APPCONF_ADC_FILTER_SMOOTHING_CONSTANT;
	conf->app_adc_conf.adc2_filter_type = APPCONF_ADC2_FILTER_TYPE;
	conf->app_adc_conf.adc2_filter_smoothing_constant = APPCONF_ADC2_FILTER_SMOOTHING_CONSTANT;
